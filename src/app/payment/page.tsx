        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                {paymentMethods.map((method, i) => (
                    <div key={i} className="glass p-8 rounded-3xl border-white/10 hover:border-primary/20 transition-all">
                        ...
                        <div className="space-y-4">
                            {method.details.map((detail, j) => (
                                <div key={j} className="flex justify-between items-center py-3 border-b border-slate-100 dark:border-white/5 last:border-0">
            ...
            {/* Instructions Card */}
            <div className="p-8 rounded-3xl bg-slate-900 dark:bg-white text-white dark:text-slate-950 flex flex-col md:flex-row items-center gap-8 border-white/10 shadow-2xl">
                ...
                <div>
                    ...
                    <p className="text-white/70 dark:text-slate-900/70 leading-relaxed mb-4">
                        After making the payment via any of the above methods, please send your <span className="font-bold text-white dark:text-slate-950">Transaction ID & Screenshot</span> to our admin team for verification.
                    </p>
